...
import {
    BusinessDetails,
    BusinessTypes,
} from "@/api/business/business.api.ts";
...
const BusinessDetailInformationSection : FC<Props> = ({business}) => {
    ...
    const items = useMemo<Item[]>(() => {
        ...
        if (business.businessType === BusinessTypes.Individual) {
            list.push(...[
                ...
                },
                {
                    ...
                    value: !!business.details.birthDate ? dayjs(business.details.birthDate).format('DD MMMM YYYY') : t(`general:key-value.notProvided`)
                }
            ])
        ...
        list.push(...[
            ...
            },
            {
                ...
                value: !!business.verifiedAt ? dayjs(business.verifiedAt).format('DD MMMM YYYY') : t(`general:key-value.notVerified`)
            },
            {
    ...
    return <section>
        ...
        <div className="grid grid-cols-12 gap-4">
            {items.map((item, idx) => <Card key={idx} className="col-span-12 md:col-span-6">
                <KeyValue>

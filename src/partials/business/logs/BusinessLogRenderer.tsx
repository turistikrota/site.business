import {
    BusinessLog,
    BusinessLogActions
} from "@/api/business/business.log.api.ts";
...
const PermissionRenderer: FC<BusinessLog> = (log) => {
    ...
    if (log.action !== BusinessLogActions.BusinessPermAdded && log.action !== BusinessLogActions.BusinessPermRemoved) return <BasicRenderer {...log} />
    return <>
        <Trans
            t={t}

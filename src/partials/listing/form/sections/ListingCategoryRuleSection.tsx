...
const ListingCategoryRuleSection: React.FC<Props> = ({rules, acceptedRules, toggleRule}) => {
    const {t, i18n} = useTranslation('listings')
    return (
        <FormSection
            className={`transition-opacity duration-200 ${rules.length > 0 ? 'opacity-100' : 'hidden opacity-0'}`}>
            <FormSection.Head>
...
export default ListingCategoryRuleSection
